...
import { Trash2, Loader2, AlertCircle, ChevronLeft } from "lucide-react";
    ...
    <div className="max-w-7xl mx-auto p-6 bg-code-bg-primary min-h-screen">
            ...
            <tbody>
              {problems.map((problem, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-4">
                    <span className="inline-block px-2.5 py-0.5 bg-code-bg-tertiary text-code-text-primary border border-code-border rounded-full text-xs font-medium">
                      {problem.tags}
                    </span>
                  </td>
                  <td className="px-4 py-4">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-red-500 hover:bg-red-600 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
      ...
      {problems.length === 0 && !loading && (
        <div className="text-center py-20 text-code-text-secondary">
          <Trash2 className="mx-auto h-16 w-16 text-code-text-secondary/50 mb-4" />
